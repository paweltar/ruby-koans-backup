...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # That's because some classess define their own send method, so it is safer to use __send__ instead.
    # However "hello".send(:reverse) looks better then "hello".__send__(:reverse).
  end
